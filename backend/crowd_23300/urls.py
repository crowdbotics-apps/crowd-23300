...
admin.site.site_header = "Crowd"
admin.site.site_title = "Crowd Admin Portal"
admin.site.index_title = "Crowd Admin"

# swagger
api_info = openapi.Info(
    title="Crowd API",
    default_version="v1",
    description="API documentation for Crowd App",
)
